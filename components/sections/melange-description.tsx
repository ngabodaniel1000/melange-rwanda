...
export function MelangeDescriptionSection() {
  return (
    <ScrollAnimator>
      <section id="about" className="w-full py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 bg-accent/5 relative overflow-hidden">
        <div className="absolute top-1/2 left-0 w-64 h-64 bg-primary/10 rounded-full blur-3xl -z-10 transform -translate-y-1/2 -translate-x-1/2"></div>
        <div className="absolute top-0 right-0 w-2 h-full bg-accent"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-secondary/10 rounded-full blur-3xl -z-10 transform translate-y-1/4 translate-x-1/4"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h3 className="text-4xl sm:text-5xl font-extrabold mb-6 text-slate-900 tracking-tight">
                A <span className="text-primary">Mélange</span>, Not a Marketplace
              </h3>
              ...
              <div className="grid gap-4 mb-8 text-slate-600">
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-primary/20 transition-all">
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-accent/20 transition-all">
              ...
              <div className="bg-gradient-to-br from-primary via-primary to-accent p-8 rounded-3xl text-white shadow-xl relative overflow-hidden">
