...
export function FounderStorySection() {
  return (
    <ScrollAnimator>
      <section id="story" className="w-full py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 text-black relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-accent/20 rounded-full blur-[120px] -translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative order-2 lg:order-1 h-[500px] md:h-[600px] w-full max-w-lg mx-auto lg:max-w-none">
              <div className="absolute inset-0 bg-primary/50 rounded-3xl transform rotate-3 scale-105 opacity-50 blur-sm transition-transform hover:rotate-6"></div>
            ...
            <div className="order-1 lg:order-2">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#0a2540] text-white rounded-full text-sm font-semibold mb-8 border border-white/10 backdrop-blur-md">
                <span className="w-2 h-2 rounded-full bg-secondary animate-pulse"></span>
                The Founder's Story
              </div>

              <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-8 text-[#0a2540] tracking-tight leading-tight">
                Bridging Two <span className="bg-clip-text bg-gradient-to-r from-primary via-secondary to-accent">Worlds</span>
              </h2>

              <div className="space-y-6 text-lg sm:text-xl text-slate-900 leading-relaxed font-light">
                <p>
              ...
              <div className="mt-10 p-8 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 transform hover:-translate-y-1 transition-transform">
                <p className="text-sm text-green-500 mb-3 tracking-widest uppercase">Our Vision</p>
